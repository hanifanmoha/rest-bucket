...
async function handleRequest(request: NextRequest, params: { client_id: string, path: string[] }): Promise<NextResponse<GeneralResponse>> {
    const { client_id, path } = params;
...
export async function GET(
    request: NextRequest,
    { params }: { params: Promise<{ client_id: string, path: string[] }> }
